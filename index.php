...
<body>
 <!-- Start Navigation -->
 <nav class="navbar navbar-expand-sm navbar-dark bg-secondary bg-color pl-5 fixed-top">
 ...
 <header class="jumbotron back-image">
  <div class="myclass mainHeading">
   <h1 class="text-uppercase text-info font-weight-bold">Welcome to SMS</h1>
   <p class="font-italic">Your Happiness is our Aim</p>
   <div>
   <a href="Requester/RequesterLogin.php" class="btn btn-success mr-4">Login</a>
   <a href="#registration" class="btn btn-secondary bg-color mr-4">Sign Up</a>
   </div>
  </div>
 ...
 <div class="jumbotron bg-secondary bg-color">
   <div class="container">
     ...
     <div class="col-lg-3 col-sm-6"> <!-- Start 1st Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <h4 class="card-title">Satyam Yadav</h4>
        <p class="card-text">Best Electronics and Fault Repair Store , Providing India's Best Service Online Fast and Reliable. I've Recommend to Visit Once</p>
       </div>
      </div>
     </div> <!-- End 1st Column -->
     <div class="col-lg-3 col-sm-6"> <!-- Start 2nd Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <h4 class="card-title">Deepsikha Yadav</h4>
        <p class="card-text">Best Electronics and Fault Repair Store , Providing India's Best Service Online Fast and Reliable. I've Recommend to Visit Once</p>
       </div>
      </div>
     </div> <!-- End 2nd Column -->
 ...
 <div class="container" id="Contact">
  ...
  <div class="row">
   ...
   <div class="col-md-4 text-center"> <!-- Start 2nd Column -->
    ...
    SMS pvt Ltd,<br>
    Tilak Nagar , Allahpur, Prayagraj<br>
    Uttar Pradesh - 211002<br>
    Phone: +0000000000<br>
  ...
  <div class="container">
   <div class="row py-3">
    ...
    <div class="col-md-6 text-right"> <!-- Start 2nd Column -->
     <small>Designed by Abhishek & Satyam &copy; 2023</small>
